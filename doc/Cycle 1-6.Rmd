...
Interestingly enough, within those who have occupations that fall under CMM, there is a higher proportion of Master's degree holders amongst the Asian population than the white population. This may suggest the higher average salary.  

## Salary Contrast by State (High-Tech)

To get a feel for which states had higher pay for whites and which had higher pay for Asians in the high-tech industry, we took the difference in salary and created the following state map. The darker blue a state is, the more Asians make in that state on average. The lighter a state is, the more whites make compared to their Asian counterparts.  
